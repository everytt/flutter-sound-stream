...
@override
Future<Map<String, Duration>> getProgress(PlayerCallback callback, ) async
{
...
{
  return  invokeMethod( callback, 'startPlayer', {'numChannels': numChannels, 'sampleRate': sampleRate},) ;
}
